	...
	<body>
		...
		<div class="container">
			...
			<section class="support">
				<h2 class="upper">Apoio</h2>

				<a href="#" class="help"><img src="img/1.png" alt=""></a>
				<a href="#" class="help"><img src="img/2.png" alt=""></a>
				<a href="#" class="help"><img src="img/3.png" alt=""></a>

				<p class="container-social">
